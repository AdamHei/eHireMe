...
import com.adam.uidesign.fragments.JobListFragment.OnListFragmentInteractionListener;
...
public class MyJobRecyclerViewAdapter extends RecyclerView.Adapter<MyJobRecyclerViewAdapter.ViewHolder> {
    ...
    public MyJobRecyclerViewAdapter(List<JobItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
